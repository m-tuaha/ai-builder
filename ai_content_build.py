            ...
            with st.expander("Quick Edit"):
                ...
                if st.button(
                    ...
                    if not choice:
                        ...
                        base_prompt = (
                            """Create a clean, high-impact product hero using the uploaded image as the exact product reference.
Center the product, remove clutter, add a soft realistic shadow, and place it on a subtle studio surface.
Background: smooth gradient in brand-friendly colors %s with high contrast.
Photographic, crisp details, polished lighting, light reflection on surface, social-media ready, square 1:1, commercial quality"""
                            % base_phrase
                        )
