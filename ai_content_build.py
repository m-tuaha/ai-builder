...
with tab2:
    ...
    # ---------- QUICK ACTIONS (Pillow) ----------
        ...
        if qa == "Add Text Overlay":
            ...
            # --- Outline options (define these BEFORE you use them) ---
                ...
                if overlay_text and overlay_text.strip():
                    ...
                    if add_outline and outline_width > 0:
                        ...
                        for dx, dy in _offsets:
                            d.text((_x + dx, _y + dy), overlay_text, font=font, fill=(0,0,0,200), anchor="mm")
                    # Main text
                    d.text((_x, _y), overlay_text, font=font, fill=fill_rgba, anchor="mm")
