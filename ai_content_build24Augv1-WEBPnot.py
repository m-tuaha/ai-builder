...
with tab2:
    ...
    if mode == "Create":
        ...
        with st.expander("Advanced options"):
            ...
            st.selectbox("Output type", ["png", "jpg", "webp"], index=0, key="create_outfmt")
    ...
    # ---------- INSPIRE (template-assisted or freeform) ----------
        ...
        with st.expander("Advanced options"):
            ...
            st.selectbox("Output type", ["png", "jpg", "webp"], index=0, key="inspire_outfmt")
    ...
    # ---------- COMBINE IMAGES (multi‑image kontext) ----------
        ...
        with st.expander("Advanced options"):
            ...
            st.selectbox("Output type", ["png", "jpg", "webp"], index=0, key="combine_outfmt")
                ...
                try:
                    if mode == "Create":
                        ...
                        img_bytes = generate_multi_image_kontext_base64(
                            ...
                            prompt_upsampling=st.session_state.get("combine_prompt_upsampling"),
                        )
